    ...
    <section className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-white via-[#f8f5f1] to-white">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          >
            Professional road transport services across all 30 districts of Odisha. 
            Same-day delivery, real-time tracking, and secure handling guaranteed.
          </motion.p>
        ...
        >
          ...
          <motion.div
            ...
            className="relative"
          >
            {/* Main Image Placeholder - Replace with your delivery truck image */}
           <div className="relative w-full h-96 rounded-3xl shadow-2xl overflow-hidden">
  <Image
    src="/images/packers-Headers3.png"  
...
export default Pakers_HeroSection
